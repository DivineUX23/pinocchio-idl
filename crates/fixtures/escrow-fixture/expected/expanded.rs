...
pub const ID: ::solana_address::Address =
    ::solana_address::Address::from_str_const("11111111111111111111111111111111111111111");
...
impl Escrow {
    ...
    pub const DISCRIMINATOR: [u8; 8] = [31u8, 213u8, 123u8, 187u8, 186u8, 22u8, 218u8, 155u8];
}
pub fn process_make_instruction(accounts: &mut [AccountView], data: &[u8]) -> ProgramResult {
    ...
    {
        let __expected_pda = ::pinocchio::Address::from(pinocchio_pubkey::derive_address(
            &[b"escrow", mint_b.address().as_ref(), &seed.to_le_bytes()],
            None,
            &[
                6u8, 221u8, 246u8, 225u8, 215u8, 101u8, 161u8, 147u8, 217u8, 203u8, 225u8, 70u8,
                206u8, 235u8, 121u8, 172u8, 28u8, 180u8, 133u8, 237u8, 95u8, 91u8, 55u8, 145u8,
                58u8, 140u8, 245u8, 133u8, 126u8, 255u8, 0u8, 169u8,
            ],
        ));
